...
global $sc_id,$c,$lno,$sc_count,$user_id,$user;
$sc_id = $_REQUEST['sid'];
$user = $_REQUEST['u'];
...
**************************************************************************/?>
	...
	/* Schedule count End*/
	   ...
	   date_default_timezone_set('America/New_York');
		...
		displaySchedule($c,$lno,$sc_count,$user_id,$sc_id,$user); 
		
		
		
		function displaySchedule(&$c,&$lno,&$sc_count,&$user_id,&$sc_id,&$user)
		{
	...
	$con=mysqli_connect('localhost', 'CrooksC', 'lulls.dug', 'CrooksC'); 
			$query = "SELECT * from schedule where schedule_id = '$sc_id'";
